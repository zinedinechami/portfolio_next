  ...
  return (
    <>
      <section id="contact" className="pb-44">
        <h1 className="text-2xl font-bold text-neutral-200 pb-1">Contact Me</h1>
        ...
        <div className="flex  text-neutral-200 pt-10 ">
          <svg
            ...
            height="25"
            fill="currentColor"
            className="mr-6 hover:text-neutral-200 transition-colors"
            viewBox="0 0 16 16"
          >
          ...
          <svg
            ...
            height="25"
            fill="currentColor"
            className="mr-4 hover:text-neutral-200 transition-colors"
            viewBox="0 0 16 16"
          >
